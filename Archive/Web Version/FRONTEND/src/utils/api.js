...
// Backend URL - Auto-switches between production (Environment Variable) and local development
export const BACKEND_URL = import.meta.env.VITE_BACKEND_URL || 'http://localhost:64621';
