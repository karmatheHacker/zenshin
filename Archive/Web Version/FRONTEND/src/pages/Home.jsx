      ...
      >
        ...
        <div className="my-12 flex h-full w-8/12 flex-col items-center justify-start gap-y-1 p-3 lg:w-2/5">
          <div className="relative flex flex-col items-center leading-none mb-8">
            ...
            <span className="absolute -bottom-4 text-2xl font-bold text-[#B026FF] drop-shadow-[0_0_10px_rgba(176,38,255,0.8)] opacity-90">カマニメ</span>
          </div>
          <p className="font-space-mono text-center">
            Stream your favourite anime torrents instantly with Kamanime, no waiting for downloads,
            reliable and seamless streaming directly to your browser.
          </p>
        </div>
